...
namespace ManagementAngajati.Controllers
{
    ...
    public class AngajatiController : ControllerBase
    {
        ...
        {
            var angajat = _angajatData.FindOne(id);
            if (angajat != null)
            {
                return Ok(Converter.AngajatToAngajatResponse(angajat.Result));
            }
        ...
        {
            var angajati = _angajatData.FindAll();
            if (angajati != null)
            {
                return Ok(Converter.AngajatListToAngajatResponseList(angajati.Result));
            }
            return NoContent();
